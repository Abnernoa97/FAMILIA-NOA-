...
.presume-screen{position:fixed;inset:0;z-index:1200;background:#f6f3ed;color:#171716;overflow:auto;overscroll-behavior:contain;padding:0 14px calc(38px + env(safe-area-inset-bottom));box-sizing:border-box}.presume-inner{width:100%;max-width:760px;margin:0 auto}.presume-head{position:sticky;top:0;z-index:20;display:flex;align-items:center;justify-content:space-between;padding:max(14px,env(safe-area-inset-top)) 0 10px;background:rgba(246,243,237,.95);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}.presume-back,.presume-iconbtn{border:0;background:#e9e4da;color:#171716;border-radius:50%;width:42px;height:42px;display:grid;place-items:center;font-size:27px;cursor:pointer}.presume-brand{text-align:center}.presume-brand b{display:block;font:600 22px Georgia,serif;letter-spacing:.04em}.presume-brand span{display:block;font:800 8px system-ui;letter-spacing:.18em;color:#8d877d;margin-top:2px}.presume-head-spacer{width:42px}
.pres-stories{display:flex!important;align-items:flex-start!important;gap:10px!important;overflow-x:auto!important;overflow-y:hidden!important;padding:6px 10px 14px 1px!important;scroll-padding-inline:1px 18px;scrollbar-width:none}.pres-stories::-webkit-scrollbar{display:none}.pres-story,.pres-story-own{position:relative;flex:0 0 68px!important;width:68px!important;min-width:68px!important;max-width:68px!important;text-align:center}.pres-story{border:0!important;background:transparent!important;padding:0!important;color:inherit!important;cursor:pointer!important}.pres-story-main{display:block;border:0;background:transparent;padding:0;margin:0 auto;color:inherit;cursor:pointer}.pres-story-ring{display:block!important;width:58px!important;height:72px!important;min-width:58px!important;min-height:72px!important;max-width:58px!important;max-height:72px!important;border-radius:21px!important;padding:3px!important;background:#d8d1c5!important;margin:0 auto!important;box-sizing:border-box!important;overflow:hidden!important}.pres-story.has-story .pres-story-ring,.pres-story-own.has-story .pres-story-ring{background:linear-gradient(145deg,#ff8c72,#a56bd1,#f2c36b)!important}.pres-story-ring-inner{display:block!important;width:100%!important;height:100%!important;border-radius:18px!important;background:#f6f3ed!important;padding:2px!important;box-sizing:border-box!important;overflow:hidden!important}.pres-story-avatar,.pres-story-avatar img{display:block!important;width:100%!important;height:100%!important;min-width:0!important;min-height:0!important;max-width:none!important;max-height:none!important;border-radius:15px!important;object-fit:cover!important}.pres-story-avatar{display:grid!important;place-items:center!important;background:#171716!important;color:#fff!important;font:800 18px system-ui!important}.pres-story small,.pres-story-own small{display:block!important;width:68px!important;max-width:68px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;font:700 10px system-ui!important;margin-top:6px!important}.pres-story-add{position:absolute;right:2px;top:50px;width:23px;height:23px;border:2px solid #f6f3ed;border-radius:50%;background:#171716;color:#fff;font:700 16px/1 system-ui;display:grid;place-items:center;padding:0;z-index:3}.pres-story-own .pres-story-main.no-story .pres-story-ring{background:#d8d1c5!important}
.pres-challenge{border-radius:27px;background:#171716;color:#fff;padding:22px 18px;margin-bottom:14px;position:relative;overflow:hidden}.pres-challenge .eyebrow{color:#bdb7ae;margin:0 0 7px}.pres-challenge h2{font:500 29px/1.05 Georgia,serif;margin:0 0 9px}.pres-challenge p{font:13px/1.45 system-ui;margin:0 0 17px;color:#d8d3cc;max-width:520px}.pres-challenge-meta{display:flex;gap:8px;flex-wrap:wrap;margin-bottom:13px}.pres-chip{display:inline-flex;align-items:center;gap:5px;border-radius:999px;padding:7px 10px;background:rgba(255,255,255,.1);font:700 10px system-ui}.pres-main{position:relative;z-index:2;width:100%;min-height:50px;border:0;border-radius:16px;background:#fff;color:#171716;font:800 13px system-ui;cursor:pointer}.pres-main.done{background:#343432;color:#f1ede7}.pres-reminder{margin-top:9px;width:100%;border:0;background:transparent;color:#bbb5ac;font:700 10px system-ui;text-decoration:underline;text-underline-offset:3px;cursor:pointer}
...
.pres-modal{position:fixed;inset:0;z-index:1400;background:#0d0d0c;display:grid;place-items:center;padding:max(12px,env(safe-area-inset-top)) 12px max(12px,env(safe-area-inset-bottom));box-sizing:border-box}.pres-sheet{width:min(100%,620px);max-height:100%;overflow:auto;background:#f8f5ef;border-radius:24px;padding:14px;box-sizing:border-box}.pres-sheet-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:10px}.pres-sheet-head b{font:500 20px Georgia,serif}.pres-sheet-close{border:0;width:38px;height:38px;border-radius:50%;background:#e9e4da;font-size:22px}.pres-preview{border-radius:19px;overflow:hidden;background:#111;display:grid;place-items:center;min-height:220px;max-height:67dvh}.pres-preview img,.pres-preview video{width:100%;max-height:67dvh;object-fit:contain}.pres-preview-actions{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:10px}.pres-retake,.pres-publish{min-height:48px;border-radius:15px;font:800 13px system-ui;cursor:pointer}.pres-retake{border:1px solid #d9d2c7;background:#fff;color:#171716}.pres-publish{border:0;background:#171716;color:#fff}.pres-publish:disabled,.pres-retake:disabled{opacity:.55}.pres-sheet textarea{width:100%;min-height:84px;border:1px solid #ddd6cc;border-radius:16px;padding:12px;margin-top:10px;box-sizing:border-box;font:13px/1.4 system-ui;resize:none;background:#fff}.pres-record{padding:24px;text-align:center}.pres-record-pulse{width:74px;height:74px;border-radius:50%;margin:0 auto 12px;background:#171716;color:#fff;display:grid;place-items:center;font-size:28px}.pres-record.recording .pres-record-pulse{animation:pulse 1.2s infinite}@keyframes pulse{50%{transform:scale(1.08);box-shadow:0 0 0 12px rgba(23,23,22,.08)}}.pres-record p{font:12px system-ui;color:#77716a}
.pres-story-view{position:fixed;inset:0;z-index:1600;background:#090909;color:#fff;display:grid;grid-template-rows:auto 1fr auto;touch-action:manipulation}.pres-story-top{display:flex;align-items:center;gap:9px;padding:max(13px,env(safe-area-inset-top)) 13px 10px}.pres-story-top .pres-post-avatar{background:#fff;color:#111}.pres-story-top b{font:700 12px system-ui;flex:1}.pres-story-close{border:0;background:rgba(255,255,255,.12);color:#fff;width:40px;height:40px;border-radius:50%;font-size:25px}.pres-story-stage{min-height:0;display:grid;place-items:center;position:relative;overflow:hidden}.pres-story-stage img,.pres-story-stage video{max-width:100%;max-height:100%;width:100%;height:100%;object-fit:contain}.pres-story-stage .pres-post-text{color:#171716;width:100%;height:100%;box-sizing:border-box;display:grid;place-items:center}.pres-story-stage audio{width:calc(100% - 34px);position:relative;z-index:3}.pres-story-caption{padding:12px 18px calc(20px + env(safe-area-inset-bottom));font:13px/1.4 system-ui;text-align:center}.pres-story-nav{position:absolute;inset:0;display:grid;grid-template-columns:1fr 1fr}.pres-story-nav button{border:0;background:transparent}.pres-story-progress{display:flex;gap:4px;padding:7px 13px 0}.pres-story-progress i{display:block;flex:1;height:3px;background:#3d3d3d;border-radius:999px;overflow:hidden}.pres-story-progress i.seen,.pres-story-progress i.active{background:#fff}
@media(max-width:520px){.presume-screen{padding-left:10px;padding-right:10px}.pres-challenge h2{font-size:27px}.pres-compose{gap:5px}.pres-post{border-radius:19px}.pres-post-media{min-height:200px}.pres-modal{padding-left:8px;padding-right:8px}.pres-sheet{border-radius:20px}}
`
...
async function loadData(){
  ...
  const ids=posts.filter(post=>new Date(post.expires_at).getTime()>Date.now()).map(post=>post.id)
  ...
  await primeMedia([...posts.map(p=>p.media_path),...memories.map(p=>p.media_path),...((commentRes.data||[]) as Comment[]).map(c=>c.voice_path),...Array.from(profiles.values()).map(p=>p.avatar_path)])
...
function reactionSummary(postId:string){const counts=new Map<string,number>();for(const r of reactionsFor(postId))counts.set(r.emoji,(counts.get(r.emoji)||0)+1);return [...counts.entries()].map(([emoji,count])=>`<span>${emoji} ${count}</span>`).join('')}
...
function storiesMarkup(){
  ...
  const meMember=data.members.find(member=>member.id===me)
  const ownHas=!!me&&latest.has(me)
  const own=me&&meMember?`<div class="pres-story-own ${ownHas?'has-story':''}"><button class="pres-story-main ${ownHas?'':'no-story'}" ${ownHas?`data-story-member="${esc(me)}"`:'data-camera'}><span class="pres-story-ring"><span class="pres-story-ring-inner">${avatarMarkup(me,'pres-story-avatar')}</span></span></button><button class="pres-story-add" data-camera aria-label="Agregar a tu historia">+</button><small>Tu historia</small></div>`:''
  const others=data.members.filter(member=>member.id!==me).map(member=>`<button class="pres-story ${latest.has(member.id)?'has-story':''}" data-story-member="${esc(member.id)}"><span class="pres-story-ring"><span class="pres-story-ring-inner">${avatarMarkup(member.id,'pres-story-avatar')}</span></span><small>${esc(member.name)}</small></button>`).join('')
  return own+others
}
...
function startRealtime(){channel?.unsubscribe();channel=supabase.channel('familia-presume-live').on('postgres_changes',{event:'*',schema:'public',table:'social_posts'},refreshSoon).on('postgres_changes',{event:'*',schema:'public',table:'social_reactions'},refreshSoon).on('postgres_changes',{event:'*',schema:'public',table:'social_comments'},refreshSoon).subscribe()}
...
async function startVoicePost(){
  ...
  const closeModal=()=>{if(recorder?.state==='recording')recorder.stop();stopAll();modal.remove()};modal.querySelector('.pres-sheet-close')!.addEventListener('click',closeModal)
...
function closeStory(){clearStoryTimer();storyOverlay?.querySelectorAll<HTMLMediaElement>('video,audio').forEach(media=>media.pause());storyOverlay?.remove();storyOverlay=null;storyResumeVideo=false}
function openStory(memberId:string,push=true){
  ...
  if(push)pushView('presume-story')
  ...
  const advance=()=>{if(paused)return;if(index<posts.length-1){index++;draw()}else history.back()}
  const schedule=()=>{clearStoryTimer();const media=root.querySelector<HTMLVideoElement>('.pres-story-stage video');if(media){media.addEventListener('ended',advance,{once:true});void media.play().catch(()=>{});return}storyTimer=window.setTimeout(advance,STORY_MS)}
  const pause=()=>{if(paused)return;paused=true;clearStoryTimer();const video=root.querySelector<HTMLVideoElement>('.pres-story-stage video');storyResumeVideo=!!video&&!video.paused;if(video)video.pause()}
  const resume=()=>{if(!paused)return;paused=false;const video=root.querySelector<HTMLVideoElement>('.pres-story-stage video');if(video&&storyResumeVideo){void video.play().catch(()=>{});storyResumeVideo=false}else schedule()}
  const draw=()=>{
    clearStoryTimer();const post=posts[index],member=memberFor(memberId)
    root.innerHTML=`<div><div class="pres-story-progress">${posts.map((_,i)=>`<i class="${i<index?'seen':i===index?'active':''}"></i>`).join('')}</div><div class="pres-story-top">${avatarMarkup(memberId)}<b>${esc(member?.name||'Familia')} · ${age(post.created_at)}</b><button class="pres-story-close">×</button></div></div><div class="pres-story-stage">${mediaMarkup(post)}<div class="pres-story-nav"><button data-story-prev aria-label="Anterior"></button><button data-story-next aria-label="Siguiente"></button></div></div><div class="pres-story-caption">${post.body&&post.media_type!=='text'?esc(post.body):'♡'}</div>`
    root.querySelector('.pres-story-close')!.addEventListener('click',()=>history.back())
    root.querySelector('[data-story-prev]')!.addEventListener('click',event=>{event.stopPropagation();if(index>0){index--;draw()}else history.back()})
    root.querySelector('[data-story-next]')!.addEventListener('click',event=>{event.stopPropagation();advance()})
    const stage=root.querySelector<HTMLElement>('.pres-story-stage')!
    stage.addEventListener('pointerdown',event=>{if((event.target as Element).closest('audio,video'))return;pause()})
    stage.addEventListener('pointerup',resume);stage.addEventListener('pointercancel',resume);stage.addEventListener('pointerleave',resume)
    schedule()
  }
  draw()
}
...
function bind(){
  ...
  overlay.querySelectorAll<HTMLFormElement>('[data-comment-form]').forEach(form=>form.addEventListener('submit',event=>{event.preventDefault();const input=form.querySelector<HTMLInputElement>('input')!,body=input.value;input.value='';void sendComment(form.dataset.commentForm||'',body).catch(error=>console.error(error))}))
  ...
  overlay.querySelectorAll<HTMLElement>('[data-react-target]').forEach(target=>{
    ...
    target.addEventListener('pointerdown',event=>{if((event.target as Element).closest('video,audio,button'))return;press=window.setTimeout(()=>{const bar=overlay?.querySelector<HTMLElement>(`[data-reaction-bar="${CSS.escape(target.dataset.reactTarget||'')}"]`);if(bar)bar.hidden=false},520)})
